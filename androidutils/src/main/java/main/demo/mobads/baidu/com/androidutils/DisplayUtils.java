...
public class DisplayUtils {
	...
	* @param @param context
	* @param @return    设定文件
	* @return DisplayMetrics   返回屏幕宽高，密度等相关信息
	* @throws
	 */
	 ...
	 * 设置透明
	 */
	public static void setLucency(TextView txtView){
        txtView.setTextColor(Color.argb(128, 255, 255, 255));
	}
	...
	public static int getScreenType(Context context)
	{
		...
		int orient = displayMetrics.heightPixels - displayMetrics.widthPixels > 0 ? 1 : 0;
		return orient;
	}
}
